...
import ClockIcon from '@pam/assets/images/icon/17.svg';
import plus from '@pam/assets/images/icon/24.svg';
import RemoveIcon from '@pam/assets/images/icon/02-icon.svg';
import CommentsIcon from '@pam/assets/images/icon/09-icon.svg';
