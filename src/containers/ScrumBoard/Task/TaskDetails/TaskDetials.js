...
import Comments from '@pam/components/ScrumBoard/Comments/Comments';
import HeadingWithIcon from '@pam/components/ScrumBoard/HeadingWithIcon/HeadingWithIcon';
import { IconSvg } from '@pam/components/ScrumBoard/IconSvg/IconSvg';
...
import PlusIcon from '@pam/assets/images/icon/24.svg';
import TitleIcon from '@pam/assets/images/icon/05-icon.svg';
import DescriptionIcon from '@pam/assets/images/icon/06-icon.svg';
import AttachmentIcon from '@pam/assets/images/icon/01-icon.svg';
import Clock from '@pam/assets/images/icon/17.svg';
import scrumBoardActions from '@pam/redux/scrumBoard/actions';
