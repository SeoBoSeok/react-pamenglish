...
import RenderBoardForm from '@pam/components/ScrumBoard/RenderBoardForm/RenderBoardForm';
import { dateFormat } from '@pam/components/ScrumBoard/FieldFormats';
import { IconSvg } from '@pam/components/ScrumBoard/IconSvg/IconSvg';
import scrumBoardActions from '@pam/redux/scrumBoard/actions';

import ArrowIcon from '@pam/assets/images/icon/04-icon.svg';
import CloseIcon from '@pam/assets/images/icon/07-icon.svg';
import {
  Wrapper,
  FormWrapper,
  Heading,
