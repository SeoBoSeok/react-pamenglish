...
import SearchInput from '@pam/components/ScrumBoard/SearchInput/SearchInput';
import { IconSvg } from '@pam/components/ScrumBoard/IconSvg/IconSvg';
import modalActions from '@pam/redux/modal/actions';
import scrumBoardActions from '@pam/redux/scrumBoard/actions';
import { variables } from '@pam/assets/styles/variables';
import AvatarIcon from '@pam/assets/images/icon/08-icon.svg';
