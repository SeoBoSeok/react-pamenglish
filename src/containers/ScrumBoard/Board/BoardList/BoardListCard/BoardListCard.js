...
import MoreIcon from '@pam/assets/images/icon/16.svg';
import PrivateIcon from '@pam/assets/images/icon/18.svg';
import PublicIcon from '@pam/assets/images/icon/19.svg';
import PlusIcon from '@pam/assets/images/icon/24.svg';
import SoftwareIcon from '@pam/assets/images/icon/20.svg';
